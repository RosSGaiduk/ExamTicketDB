...
public interface StudentService {
    void add(String name,String lastName,int age,int course,String form,String facultyName);
    void add(StudentOfLnu studentOfLnu);
    void edit(long id,String name,String lastName,int age,int course,String form);
